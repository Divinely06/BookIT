...
const printApprovedBooking = (booking: Booking) => {
  ...
  <h2>Approval signatures</h2><div class="signatures"><div class="signature"><span class="signature-mark">Maria Santos</span><b>Prof. Maria Santos</b>Faculty Adviser<small>Sample electronic signature</small></div><div class="signature"><span class="signature-mark">Elena Cruz</span><b>Dr. Elena Cruz</b>Dean / Subject Chair<small>Sample electronic signature</small></div><div class="signature"><span class="signature-mark">Paolo Reyes</span><b>Engr. Paolo Reyes</b>CDMO Representative<small>Sample electronic signature</small></div><div class="signature"><span class="signature-mark">Admin Office</span><b>Admin Office</b>Final Booking Confirmation<small>Sample electronic signature</small></div></div>
...
function Review({
  ...
  const application: ActivityApplicationData = booking.activityApplication ?? {
    school: undefined,
    academicYear: undefined,
    tagline: undefined,
    mode: "Face-to-face",
    targetParticipants: booking.org,
    sdgAlignment: "",
    sdgs: [],
    sdgExplanations: {},
    eventTitle: booking.event,
    activityDate: booking.eventDate ?? booking.date,
    venue: booking.venue,
    startTime: booking.time.split(" – ")[0] ?? "09:00",
    endTime: booking.time.split(" – ")[1] ?? "16:00",
    purpose: booking.purpose,
    people: booking.people,
    category: "Co-Curricular",
    size: "Minor",
    memberCount: booking.people,
    applicantName: booking.org,
    studentNumber: "",
    programYear: "",
    submissionDate: booking.eventDate ?? booking.date,
    position: "Organization representative",
    nature: "Organization activity",
    objectives: booking.purpose,
    individualContribution: "",
    missionAlignment: [],
    coreValuesExplanation: "",
    peoPo: "",
